...
class CollisionGenerator {
    ...
    private Map<String, Double> mDxMap = new HashMap<String, Double>();
    private Map<String, Double> mDyMap = new HashMap<String, Double>();
    private Map<String, Node> mNodeMap = new HashMap<String, Node>();
    private double k;
